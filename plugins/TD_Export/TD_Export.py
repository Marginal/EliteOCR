...
class TD_Export():
    ...
    def addMapping(self):
        ...
        self.mapOCR2TD["ANCIENT ARTEFACT"] = [ "Ancient Artefact", "Salvage" ]
        ...
        self.mapOCR2TD["BISMUTH"] = [ "Bismuth", "Metals" ]
        self.mapOCR2TD["BOOTLEG LIQUOR"] = [ "Bootleg Liquor", "Legal Drugs" ]
        self.mapOCR2TD["BUILDING FABRICATORS"] = [ "Building Fabricators", "Machinery" ]
        self.mapOCR2TD["CERAMIC COMPOSITES"] = [ "Ceramic Composites", "Industrial Materials" ]
        ...
        self.mapOCR2TD["CRYOLITE"] = [ "Cryolite", "Minerals" ]
        self.mapOCR2TD["DOMESTIC APPLIANCES"] = [ "Domestic Appliances", "Consumer Items" ]
        self.mapOCR2TD["EVACUATION SHELTER"] = [ "Evacuation Shelter", "Consumer Items" ]
        self.mapOCR2TD["EXPERIMENTAL CHEMICALS"] = [ "Experimental Chemicals", "Salvage" ]
        ...
        self.mapOCR2TD["GEOLOGICAL EQUIPMENT"] = [ "Geological Equipment", "Machinery" ]
        self.mapOCR2TD["GOLD"] = [ "Gold", "Metals" ]
        self.mapOCR2TD["GOSLARITE"] = [ "Goslarite", "Minerals" ]
        self.mapOCR2TD["GRAIN"] = [ "Grain", "Foods" ]
        self.mapOCR2TD["H.E. SUITS"] = [ "H.E. Suits", "Technology" ]
        self.mapOCR2TD["HAFNIUM 178"] = [ "Hafnium 178", "Metals" ]
        ...
        self.mapOCR2TD["LANDMINES"] = [ "Landmines", "Weapons" ]
        self.mapOCR2TD["LANTHANUM"] = [ "Lanthanum", "Metals" ]
        ...
        self.mapOCR2TD["META-ALLOYS"] = [ "Meta-Alloys", "Industrial Materials" ]
        self.mapOCR2TD["MICROBIAL FURNACES"] = [ "Microbial Furnaces", "Machinery" ]
        self.mapOCR2TD["MILITARY INTELLIGENCE"] = [ "Military Intelligence", "Salvage" ]
        self.mapOCR2TD["MILITARY PLANS"] = [ "Military Plans", "Salvage" ]
        self.mapOCR2TD["MINERAL EXTRACTORS"] = [ "Mineral Extractors", "Machinery" ]
        self.mapOCR2TD["MINERAL OIL"] = [ "Mineral Oil", "Chemicals" ]
        self.mapOCR2TD["MOISSANITE"] = [ "Moissanite", "Minerals" ]
        self.mapOCR2TD["MUON IMAGER"] = [ "Muon Imager", "Technology" ]
        self.mapOCR2TD["NARCOTICS"] = [ "Narcotics", "Legal Drugs" ]
        self.mapOCR2TD["NATURAL FABRICS"] = [ "Natural Fabrics", "Textiles" ]
        self.mapOCR2TD["NERVE AGENTS"] = [ "Nerve Agents", "Chemicals" ]
        self.mapOCR2TD["NON-LETHAL WEAPONS"] = [ "Non-Lethal Weapons", "Weapons" ]
        self.mapOCR2TD["OSMIUM"] = [ "Osmium", "Metals" ]
        ...
        self.mapOCR2TD["PROTOTYPE TECH"] = [ "Prototype Tech", "Salvage" ]
        self.mapOCR2TD["PYROPHYLLITE"] = [ "Pyrophyllite", "Minerals" ]
        ...
        self.mapOCR2TD["SAP 8 CORE CONTAINER"] = [ "SAP 8 Core Container", "Salvage" ]
        ...
        self.mapOCR2TD["SKIMMER COMPONENTS"] = [ "Skimmer Components", "Machinery" ]
        self.mapOCR2TD["SLAVES"] = [ "Slaves", "Slavery" ]
        self.mapOCR2TD["STRUCTURAL REGULATORS"] = [ "Structural Regulators", "Technology" ]
        self.mapOCR2TD["SUPERCONDUCTORS"] = [ "Superconductors", "Industrial Materials" ]
        self.mapOCR2TD["SURFACE STABILISERS"] = [ "Surface Stabilisers", "Chemicals" ]
        self.mapOCR2TD["SYNTHETIC FABRICS"] = [ "Synthetic Fabrics", "Textiles" ]
        self.mapOCR2TD["SYNTHETIC MEAT"] = [ "Synthetic Meat", "Foods" ]
        self.mapOCR2TD["SYNTHETIC REAGENTS"] = [ "Synthetic Reagents", "Chemicals" ]
        self.mapOCR2TD["TANTALUM"] = [ "Tantalum", "Metals" ]
        self.mapOCR2TD["TEA"] = [ "Tea", "Foods" ]
        self.mapOCR2TD["TECHNICAL BLUEPRINTS"] = [ "Technical Blueprints", "Salvage" ]
        self.mapOCR2TD["THALLIUM"] = [ "Thallium", "Metals" ]
        self.mapOCR2TD["THERMAL COOLING UNITS"] = [ "Thermal Cooling Units", "Machinery" ]
        self.mapOCR2TD["THORIUM"] = [ "Thorium", "Metals" ]
        self.mapOCR2TD["TITANIUM"] = [ "Titanium", "Metals" ]
        self.mapOCR2TD["TOBACCO"] = [ "Tobacco", "Legal Drugs" ]
        self.mapOCR2TD["TRADE DATA"] = [ "Trade Data", "Salvage" ]
        self.mapOCR2TD["TRINKETS OF HIDDEN FORTUNE"] = [ "Trinkets Of Hidden Fortune", "Salvage" ]
        self.mapOCR2TD["UNKNOWN ARTEFACT"] = [ "Unknown Artefact", "Salvage" ]
